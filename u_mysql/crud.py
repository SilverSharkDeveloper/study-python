...
@execute_crud
def find_all_by_member_id(cursor: Cursor, query: str,params:list):
    cursor.execute(query,params)
    return cursor.fetchall()
...
@execute_crud
def find_by_id(cursor: Cursor, query: str, params):
    cursor.execute(query, params)
    return cursor.fetchall()

@execute_crud
def find_one(cursor: Cursor, query: str,params:list):
    cursor.execute(query,params)
